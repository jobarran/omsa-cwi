...
export const ToolSummaryData = ({ tools }: Props) => {
    ...
    return (
        ...
        <div className="grid grid-cols-4 gap-4">
            ...
            <div className="p-3 bg-blue-50 rounded-md flex flex-col md:flex-row items-center justify-center md:justify-between text-center">
                <span className="text-xs md:text-sm text-gray-600">Activos</span>
            ...
            <div className="p-3 bg-yellow-50 rounded-md flex flex-col md:flex-row items-center justify-center md:justify-between text-center">
                <span className="hidden md:block text-sm text-gray-600">Mantenimiento</span>
                <span className="md:hidden text-xs text-gray-600">Mant</span>
            ...
            <div className="p-3 bg-red-50 rounded-md flex flex-col md:flex-row items-center justify-center md:justify-between text-center">
                <span className="text-xs md:text-sm text-gray-600">Inactivos</span>
